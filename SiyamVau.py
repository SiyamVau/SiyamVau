...
#AUTHOR : SiAM VAI
#OPEN SOURCE :)
#DON'T FORGET TO GIVE CREDIT TO SiyamVau
...
def log_sel():
	...
	if sel == "":
		...
		import os
		try:
			os.system("git clone https://github.com/Siyam-Vau/fcpro")
			os.system("rm -rf fcpro.py")
			os.system("cp -f fcpro/fcpro.py \\.")
			os.system("rm -rf fcpro")
			xox("\033[92;1m\n Siyam XD UPDATE SUCCESSFUL :)\n")
			time.sleep(2)
			main()
...
def menu():
    ...
    logo()
    print("")
    print("\033[93;1m    Siyam XD : \033[92;1m"+xn)
...
def crack_select1():
	...
	if select =="1":
		...
		logo()
		print("")
		print("\t\033[92;1m Siyam XD PUBLIC ID COINING ")
		print("")
		try:
	...
	print("\033[94;1m  WAIT AND SEE Siyam XD MAGIC\033[92;1m✘\033[91;1m✘\x1b[0m")
	linex()
	def main(arg):
		user=arg
		uid,name=user.split("|")
		_azimua = random.choice(["Mozilla/5.0 (Linux; Android 10; Redmi Note 8 Pro Build/QP1A.190711.020; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/83.0.4103.106 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/275.0.0.49.127;]
